...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://postgres:wythenshawe0513@localhost:5432/{}".format(self.database_name)
        #self.database_path = "postgres://{}/{}".format('localhost:5432', self.database_name)
        # postgresql://postgres:wythenshawe0513@localhost:5432/{}".format(database_name)
